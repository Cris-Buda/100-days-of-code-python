...
class FlightSearch:
    def __init__(self):
        ...
        self._api_secret = os.environ[" "]
        self._token_endpoint = os.environ["TOKEN_ENDPOINT"]
    ...
    def get_destination_code(self, city_name):
        print(f"Using this token to get destination { }")
        ...
        try:
            ...
            code = response_json["data"][0]['iataCode']
        except IndexError:
